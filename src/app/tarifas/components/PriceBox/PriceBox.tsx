...
export default function PriceBox({ title, price, plan }: PriceBoxProps) {
  return (
    <div className="flex flex-col items-center justify-center w-full min-w-80 bg-lime-50 bg-opacity-60 rounded-lg shadow-lg m-2 p-2 border-2 border-black z-10">
